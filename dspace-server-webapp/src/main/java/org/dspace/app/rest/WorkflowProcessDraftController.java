    ...
    public ResponseEntity create(@RequestBody WorkFlowProcessRest workFlowProcessRest) throws Exception {
        ...
        try {
            ...
            if(workFlowProcessRest.getRemark()!=null) {
                System.out.println("set remark in ep");
            ...
            if (workFlowProcessRest.getWorkFlowProcessCommentRest() != null && workFlowProcessRest.getWorkFlowProcessCommentRest().getWorkflowProcessReferenceDocRest() != null) {
                ...
                if (workflowProcess != null && workFlowProcessComment2 != null) {
                    ...
                    try {
                        ...
                        //create note pdf
                        fileInputa = null;//createFinalNoteComment(context12, workflowProcess, tempFile1html);
                        if (fileInputa != null) {
        ...
        try {
            ...
            try {
                ...
                if (statusCode == 200) {
                    ...
                    Bitstream bitstreampdfsing =null;// bundleRestRepository.processBitstreamCreationWithoutBundle(context, pdfFileInputStream, "", tempsingpdf.getName());
