 ...
 */
public class BitstreamResourceDigitalsign extends AbstractResource {
    ...
    public BitstreamResourceDigitalsign(String name, UUID uuid, UUID currentUserUUID, Set<UUID> currentSpecialGroups,
