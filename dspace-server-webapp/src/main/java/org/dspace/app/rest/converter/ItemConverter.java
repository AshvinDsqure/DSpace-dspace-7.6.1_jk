...
public class ItemConverter
    ...
    public ItemRest convert(Item obj, Projection projection) {
        ...
        if(obj.getOwningCollection()!=null && obj.getOwningCollection().getName()!=null) {
    ...
    public ItemRest convertWihoutMataData(Item obj, Projection projection) {
        ItemRest item = new ItemRest();
        item.setId(obj.getID().toString());
