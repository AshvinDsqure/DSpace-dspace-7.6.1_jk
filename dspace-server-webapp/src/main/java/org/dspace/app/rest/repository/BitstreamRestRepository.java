...
public class BitstreamRestRepository extends DSpaceObjectRestRepository<Bitstream, BitstreamRest> {
    ...
    protected void delete(Context context, UUID id) throws AuthorizeException {
        ...
        try {
            ...
            Item item=itemService.findItemByBitstream(context,bit);
    ...
    @SearchRestMethod(name = "getMeargePDFByItemID")
    public BitstreamRest getMeargePDFByItemID(@Parameter(value = "itemID", required = true) String itemID){
        if (StringUtils.isBlank(itemID)){
            throw new IllegalArgumentException("The request should include a itemID or a filename");
        }
        ...
        try {
            ...
            if (bundles.size() < 1) {
                ...
                if(bitstreamOption.isPresent()){
                    return converter.toRest(bitstreamOption.get(), utils.obtainProjection());
                }else{
                    return  null;
                }
            }
