...
public interface BitStoreService {
    ...
    public File getActualFile(Bitstream bitstream) throws IOException;
    ...
    public void putEditBitstream(Bitstream bitstream, InputStream inputStream) throws IOException;
