 ...
 */
public class ContextCIS implements AutoCloseable {
    private static final Logger log = org.apache.logging.log4j.LogManager.getLogger(ContextCIS.class);
    ...
    private DBConnectionCIS ciddbConnection;
    ...
    protected ContextCIS(EventService eventService, DBConnectionCIS ciddbConnection) {
        this.eventService = eventService;
        this.ciddbConnection = ciddbConnection;
        init();
    }
    ...
    protected void init() {
        ...
        if (ciddbConnection == null) {

            ciddbConnection=new DSpace().getServiceManager()
                    .getServiceBeanName("org.dspace.core.DBConnectionCIS", DBConnectionCIS.class);
            if (ciddbConnection == null) {
     ...
     */
    public DBConnectionCIS getDBConnection() {
        return ciddbConnection;
    }

    public DatabaseConfigVO getDBConfig() throws SQLException {
        return ciddbConnection.getDatabaseConfig();
    }

    public String getDbType() {
        return ciddbConnection.getType();
    }
    ...
    public void complete() throws SQLException {
        ...
        try {
            ...
            if (ciddbConnection != null) {
                ...
                ciddbConnection.closeDBConnection();
                ciddbConnection = null;
            }
        }
    }
     ...
     * manually after this method call (see {@link ContextCIS#reloadEntity(ReloadableEntity)}).</b>
     *
    ...
    public boolean isValid() {
        ...
        return ciddbConnection != null && ciddbConnection.isSessionAlive();
    }
    ...
    protected boolean isTransactionAlive() {
        ...
        return isValid() && ciddbConnection.isTransActionAlive();
    }
    ...
    protected void finalize() throws Throwable {
         ...
         */
        if (ciddbConnection != null && ciddbConnection.isTransActionAlive()) {
            abort();
        }
     ...
     * needed (see {@link ContextCIS#uncacheEntity(ReloadableEntity)} () uncacheEntity}).
     *
     * @return cache size.
    ...
    public void setMode(Mode newMode) {
        try {
            ...
            switch (newMode) {
                case BATCH_EDIT:
                    ciddbConnection.setConnectionMode(true, false);
                    break;
                case READ_ONLY:
                    ciddbConnection.setConnectionMode(false, true);
                    break;
                case READ_WRITE:
                    ciddbConnection.setConnectionMode(false, false);
                    break;
                default:
    ...
    public <E extends ReloadableEntity> E reloadEntity(E entity) throws SQLException {
        return (E) ciddbConnection.reloadEntity(entity);
    }
    ...
    public <E extends ReloadableEntity> void uncacheEntity(E entity) throws SQLException {
        ciddbConnection.uncacheEntity(entity);
    }
    ...
    public DBConnectionCIS getCiddbConnection() {
        return ciddbConnection;
    }

    public void setCiddbConnection(DBConnectionCIS ciddbConnection) {
        this.ciddbConnection = ciddbConnection;
    }
}
