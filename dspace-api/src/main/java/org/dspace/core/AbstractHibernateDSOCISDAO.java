 ...
 */
public abstract class AbstractHibernateDSOCISDAO<T extends DSpaceObjectCIS> extends AbstractHibernateCISDAO<T> {
    /**
     ...
     * @throws SQLException
     */
    public T findByLegacyId(ContextCIS context, int legacyId, Class<T> clazz) throws SQLException {
