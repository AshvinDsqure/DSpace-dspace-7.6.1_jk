 ...
 */
public interface DmsEventService extends DSpaceObjectService<DmsEvent>, DSpaceObjectLegacySupportService<DmsEvent> {
     ...
     * @param dmsEvent  DocumentType
     * @return the newly created item
     * @throws SQLException       if database error
     * @throws AuthorizeException if authorization error
     */
    public DmsEvent create(Context context, DmsEvent dmsEvent) throws SQLException, AuthorizeException;
