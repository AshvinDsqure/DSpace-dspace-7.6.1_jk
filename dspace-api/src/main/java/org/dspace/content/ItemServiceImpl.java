...
prevent the generation of resource policy entry values with null dspace_object as value
    ...
    */
    ...
    @Override
    public int countTotal1(Context context, String startdate, String endDate) throws SQLException {
    ...
    public Item findByCIno(Context context,String cino) throws SQLException{
        return  itemDAO.findByCIno(context,cino);
    }
    @Override
    public Item findItemByBitstream(Context context,Bitstream bitstreamid) throws SQLException {
        return itemDAO.findItemByBitstream(context,bitstreamid);
    }
