...
public class BitstreamServiceImpl extends DSpaceObjectServiceImpl<Bitstream> implements BitstreamService {
    ...
    @Override
    public File getorginalFile(Context context, Bitstream bitstream) throws SQLException, IOException{
        return bitstreamStorageService.getorginalFile(context, bitstream);
    }
    ...
    @Override
    public Bitstream createWithoutBundleEditBitstream(Context context, InputStream is,Bitstream bitstream) throws IOException, SQLException, AuthorizeException {
        Bitstream b = createEditBitstream(context, is,bitstream);
        return b;
    }
    @Override
    public Bitstream createEditBitstream(Context context, InputStream is,Bitstream bitstream) throws IOException, SQLException {
        UUID bitstreamID = bitstreamStorageService.storeEditBitstream(context, bitstream, is);
        return bitstream;
    }
}
